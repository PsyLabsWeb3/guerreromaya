...
const stepsData: StepData[] = [
  ...
  { icon: iconGM, title: "2. PROVE", text: "Take the Quiz and prove your understanding" },
  { icon: iconGM, title: "3. EARN", text: "Get $MZCAL based on your quiz score" }
];
      ...
      >
        ...
        <div className="mg-text-content">
          ...
          <motion.p className="mg-text">
            Kukulcan AI will guide you through key topics from the ecosystem. Once ready, take the Quiz 
            and earn your spot in the rewards pool.
          </motion.p>
          </div>
