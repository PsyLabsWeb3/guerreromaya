  ...
  const faqs: FaqItem[] = [
    {
      ...
      answer: "$MZCAL is the native token of the Guerrero Maya ecosystem, used for in-game transactions, staking, NFT trading, and real-world asset investments."
    },
    {
      question: "Which blockchain is $MZCAL on?",
      answer: "$MZCAL is deployed on Mode Network, ensuring fast, low-cost, and EVM-compatible transactions."
    },
    {
      question: "How can I acquire $MZCAL?",
      answer: "You can obtain $MZCAL through the presale, in-game marketplace trading, staking rewards, and SocialFi mini-games."
    },
    {
      question: "What is the total supply of $MZCAL?",
      answer: "The total supply of $MZCAL is 1,000,000,000, with controlled emissions governed by Kukulcán AI."
    },
    {
      question: "How does $MZCAL prevent inflation?",
      answer: "Kukulcán AI dynamically adjusts the token's emission, distribution, and burn mechanisms to maintain economic balance and long-term sustainability."
    },
    {
    ...
    },
    {
      ...
      answer: "Users can purchase fractionalized ownership of mezcal barrels through ERC-1155 tokens. The barrels age for 12 months, increasing their value by 20%, after which they can be claimed, resold, or used in DeFi as collateral."
    },
    {
      question: "What is the role of Kukulcán AI in $MZCAL's economy?",
      answer: "Kukulcán AI controls token issuance, adjusts rewards, manages difficulty scaling, and executes burn mechanisms, ensuring a balanced and adaptive economy."
    },
    {
