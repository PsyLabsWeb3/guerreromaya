  ...
  return (
    ...
    >
      ...
      <motion.div className="mzcal7-content">
        ...
        >
          <p>
            <span className="highlight">🔥 $MZCAL is not just a token; it's the heartbeat of Guerrero Maya. 🔥</span>
          </p>
          <p>
            Every $MZCAL you acquire in the Pre-Sale isn't just an asset—it's your key to an AI-powered, 
            player-driven economy where strategy, ownership, and engagement define your rewards.
          </p>
        </motion.div>
