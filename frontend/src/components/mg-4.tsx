    ...
    >
      ...
      <div className="mg-text-content">
        ...
        <motion.p className="mg-text">
          Post, interact, and climb the ranks to earn exclusive rewards. 
          Your activity fuels the growth of the community and gets recognized. 
          Become a champion of the cause and unlock perks only the brave can reach.
        </motion.p>
      </div>
    </motion.div>
