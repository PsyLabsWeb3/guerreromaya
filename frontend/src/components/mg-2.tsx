  ...
  >
    ...
    >
      ...
      <motion.p 
        ...
        {...variants.textContent}
      >
        Kukulcán will generate custom challenges based on player activity and engagement. Through interactive on-chain and off-chain mini-games, users will be able to learn, test their knowledge, and earn $MZCAL as a reward for participation. Every interaction brings you closer to unlocking exclusive benefits and becoming a true Guerrero Maya.
      </motion.p>
